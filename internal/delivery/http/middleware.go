...
var credentialsMap = map[string]string{
	"pdhoang91@gmail.com": "money_forward_vietnam",
}
...
func checkCredentials(username, password string) bool {
	...
	//password:money_forward_vietnam
	//Basic Authentication: Basic cGRob2FuZzkxQGdtYWlsLmNvbTptb25leV9mb3J3YXJkX3ZpZXRuYW0=
